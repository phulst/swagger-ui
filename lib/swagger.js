...
(function() {
  ...
  SwaggerApi = (function() {
    ...
    function SwaggerApi(options) {
      ...
      discoveryUrlFromCookie = this.readCookie("discoveryUrl");
      if (discoveryUrlFromCookie) {
        this.discoveryUrl = discoveryUrlFromCookie;
        $('#input_baseUrl').val(this.discoveryUrl);
      }
      ...
      var parName = options.apiKeyParameterName;
      this.api_key_parameter_name = (parName != null) ? parName : 'api_key';

      apiKeyFromCookie = this.readCookie("apiKey");
      if (apiKeyFromCookie) {
        this.api_key = apiKeyFromCookie;
        $('#input_apiKey').val(this.api_key);
      }
    ...
    SwaggerApi.prototype.suffixApiKey = function(url) {
      ...
      if ((this.api_key != null) && jQuery.trim(this.api_key).length > 0 && (url != null)) {
        sep = url.indexOf('?') > 0 ? '&' : '?';
        return url + sep + this.api_key_parameter_name + '=' + this.api_key;
      } else {
        return url;
      }
    };

    SwaggerApi.prototype.readCookie = function(name) {
      nameEQ = name+"="
  ...
  SwaggerOperation = (function() {
    ...
    SwaggerOperation.prototype.urlify = function(args, includeApiKey) {
      ...
      if (includeApiKey && (this.resource.api.api_key != null) && this.resource.api.api_key.length > 0) {
        args[this.resource.api.api_key_parameter_name] = this.resource.api.api_key;
      }
    ...
    SwaggerOperation.prototype.getMatchingParams = function(paramTypes, args, includeApiKey) {
      ...
      if (includeApiKey && (this.resource.api.api_key != null) && this.resource.api.api_key.length > 0) {
        matchingParams[this.resource.api.api_key_parameter_name] = this.resource.api.api_key;
      }
